...
h_separable = fspecial('gaussian', [1 11], 2.5)'; % Vertical
h_separable = h_separable / sum(h_separable); % Normalize
gflt_imns=conv2(h_separable,h_separable,imns);
gflt_imng=conv2(h_separable,h_separable,imng);
...
medflt_imns=medfilt2(imns, [5 5]);
medflt_imng=medfilt2(imng, [5 5]);
...
% Use formulas (3.34)-(3.37) from Szeliski's book with values sigma_d=sigma(1), 
% sigma_r=sigma(2)
